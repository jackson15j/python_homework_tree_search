...
- Running the code/tests:
  ...
  Building wheels for collected packages: tree_search
    ...
    Created wheel for tree_search: filename=tree_search-0.1.dev46+gd29e381.d20240114-py3-none-any.whl size=30616 sha256=07657a950c3977107ff8742de5312b0164a0ee74bec66856955ce601e82444fd
    Stored in directory: /private/var/folders/tl/tpmbfj7n33x27vbhqn_70y1r0000gn/T/pip-ephem-wheel-cache-srm13jt9/wheels/0b/cb/f4/f6ed325ef008f287116cbe2c35870a9a9c4b07c2ddf5554b14
  ...
  Successfully installed MarkupSafe-2.1.3 coverage-7.4.0 iniconfig-2.0.0 jinja2-3.1.3 packaging-23.2 pluggy-1.3.0 pytest-7.4.4 pytest-cov-4.1.0 pytest-html-4.1.1 pytest-metadata-3.0.0 tree_search-0.1.dev46+gd29e381.d20240114
  ...
  tests/unit/test_depth_first_search_stack.py::TestDepthFirstSearchStack::test_depth_first_search_simple_graph PASSED [  8%]
  tests/unit/test_depth_first_search_stack.py::TestDepthFirstSearchStack::test_depth_first_search_simple_graph_that_mimics_expected_data PASSED [ 16%]
  tests/unit/test_depth_first_search_stack.py::TestDepthFirstSearchStack::test_depth_first_search_real_data PASSED [ 25%]
  tests/unit/test_main.py::TestMain::test_get_unique_companies_without_funds PASSED [ 33%]
  tests/unit/test_main.py::TestMain::test_is_golden_gadgets_under_ethical_global_fund PASSED [ 41%]
  tests/unit/test_main.py::TestMain::test_what_percentage_of_investment_is_in_golden_gadgets PASSED [ 50%]
  tests/unit/test_parked_brute_force.py::TestParkedBruteForce::test_is_company_under_root_fund PASSED [ 58%]
  tests/unit/test_parked_brute_force.py::TestParkedBruteForce::test_is_company_not_under_root_fund PASSED [ 66%]
  tests/unit/test_parked_brute_force.py::TestParkedBruteForce::test_get_companies PASSED [ 75%]
  tests/unit/test_parked_brute_force.py::TestParkedBruteForce::test_get_company_percentage_investment SKIPPED [ 83%]
  tests/unit/test_parked_brute_force.py::TestParkedBruteForce::test_get_company_percentage_investment_exp_not_found SKIPPED [ 91%]
  ...
  0.00s setup    tests/unit/test_depth_first_search_stack.py::TestDepthFirstSearchStack::test_depth_first_search_simple_graph
  0.00s call     tests/unit/test_depth_first_search_stack.py::TestDepthFirstSearchStack::test_depth_first_search_simple_graph
  ...
  0.00s call     tests/unit/test_depth_first_search_stack.py::TestDepthFirstSearchStack::test_depth_first_search_simple_graph_that_mimics_expected_data
  0.00s call     tests/unit/test_parked_brute_force.py::TestParkedBruteForce::test_is_company_not_under_root_fund
  0.00s setup    tests/unit/test_depth_first_search_stack.py::TestDepthFirstSearchStack::test_depth_first_search_simple_graph_that_mimics_expected_data
  0.00s teardown tests/unit/test_depth_first_search_stack.py::TestDepthFirstSearchStack::test_depth_first_search_simple_graph
  0.00s setup    tests/unit/test_parked_brute_force.py::TestParkedBruteForce::test_get_company_percentage_investment
